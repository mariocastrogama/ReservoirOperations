...
% function h = subtightplot(m,n,p,gap,marg_h,marg_w,varargin)
% A wrapper function for Matlab function subplot. 
% Adds the ability to define the gap between neighbouring subplots. 
%
% Unfortunately MATLAB subplot function lacks this functionality, 
% and the gap between subplots can reach 40% of figure area, 
% which is pretty lavish.  
%
...
%
% Output arguments: 
%   h     :  same as subplot- none, or axes handle according to function call.
%
% Issues & Comments: 
%   1     : If additional elements are used in order to be passed to subplot,
%           gap parameter must be defined. 
%   2     : For default gap value use empty element- [].
%   3     : To use MATLAB subplot function in the command window
%              clear subplot
%
%  Felipe G. Nievinski
%  28 Dec 2012 (Updated 08 Jan 2013)
%
% Example: 
%   h = subtightplot(2,3,1:2,[0.5,0.2])
% 
